...
This machine is connected to a shared coordination bus (MCP server `crewmate`) used by every teammate's Claude Code. Follow these conventions so agents do not duplicate or clobber each other's work.
